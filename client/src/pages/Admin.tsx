                ...
                <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center">
                    <div className="bg-white rounded-lg p-8 shadow-2xl flex flex-col items-center gap-4">
                        ...
                        <div className="text-center">
                            <h3 className="text-xl font-semibold text-gray-800 mb-2">Loading Model...</h3>
                            <p className="text-gray-600 text-sm">This may take 20-30 seconds</p>
                            <p className="text-gray-500 text-xs mt-1">Please wait while the model loads</p>
                        </div>
                    </div>
                </div>
            )}
